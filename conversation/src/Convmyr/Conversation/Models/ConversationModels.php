...
class Models
{
    ...
    {
        static::$models[ConversationMessage::class] = $model;
    }
    ...
    {
        static::$models[ConversationThread::class] = $model;
    }
    ...
    {
        return static::make(ConversationMessage::class, $attributes);
    }
    ...
    {
        return static::make(ConversationThread::class, $attributes);
    }
